      ...
      child: Column(
        children: <Widget>[
          Padding(
            ...
            child: TextFormField(
              style: TextStyle(color: widget.dialOutputTextColor ?? Colors.black),
            ...
            children: <Widget>[
              Expanded(
                child: widget.hideDialButton != null && widget.hideDialButton!
                    ...
                    : Center(
                  child: DialButton(
                    icon: widget.dialButtonIcon != null ? widget.dialButtonIcon : Icons.phone_sharp,
                    color: widget.dialButtonColor != null ? widget.dialButtonColor! : CustomTheme.secondary,
                    hideSubtitle: widget.hideSubtitle!,
                    onTap: (value) {
